...
/* 
This class is responsible for activating and navigating the Gnower game entity. 
*/
public class GnowerController : MonoBehaviour
{
    [SerializeField]
    private GameObject _gnowerModel;
    ...
    [SerializeField]
    private AudioClip _biteSoundClip;
    ...
    // In Update we implement the chase sequence. Its activates when user approches the Gnower. It will chase AJ for certain distance. The Gnower can capture AJ and end the game. 
    void Update()
    {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            GetComponent<Transform>().GetComponent<Rigidbody>().constraints =
