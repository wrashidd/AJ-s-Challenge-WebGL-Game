...
/*
Main Player Controller class that handles players game logic
*/
public class PlayerController : MonoBehaviour
{
    ...
    [HideInInspector]
    public bool playerMovementIsOn = false;
    ...
    [SerializeField]
    private AudioClip _walkStepsSoundClip;

    [SerializeField]
    private AudioClip _runningStepsSoundClip;

    [SerializeField]
    private AudioClip _JumpingSoundClip;
    private AudioSource _audioSource;

    [HideInInspector]
    public bool _hasHandleExitingLevelRun = false;
    private ParticleSystem _spawnFX;

    // Preloads and Sets default parameters of player object animations
    // Sets default user inputs
    private void Awake()
    {
    ...
    // Preloads Particle and Sound FX
    private void Start()
    {
    ...
    // Handles Player Movement, Rotation, Jump, Walking and Running
    // Handles Players interactions with other game entities
    void Update()
    {
    ...
    // Handles players movement and speed
    ...
    // Tracks if user pressed running button
    void onRun(InputAction.CallbackContext context)
    {
        _isRunPressed = context.ReadValueAsButton();
    }

    // Tracks if user jumped
    ...
    // Sets Jump time values, Gravity values, Jump velocity
    ...
    // Handles Level Exiting Animation
    ...
    // Triggers Players death in case of interaction with hostile game entities
    // Triggers Game Over
    ...
    // Triggers movement of pushable game objects
